...
- `button-practice`/  
  ...
  - screenshot 
   ![button-practice](assets/button-practice.png)
...
- `img-styling-practice`/  
  ...
  - screenshot 
   ![img-styling-practice](assets/img-styling-practice.png)
...
- `div-practice`/  
  Practicing different ways to style and structure `<div>` elements. Includes:
...
- `google-font-practice`/  
  ...
  - screenshot 
   ![google-font-practice](assets/google-font-practice.png)
...
- `nested-layout-technique`/  
  ...
  - screenshot 
   ![nested-layout-technique](assets/nested-layout.png)
...
- `Nested-Flexbox-practice`/
    ...
    - screenshot 
    ![nested-flexbox-practice](assets/nested-flexbox.png)
